...
* **基于前馈重建模型的纯视觉语义 SLAM**
  * 项目介绍：基于 DepthAnythingV3等前馈重建模型的纯视觉导航与定位方案。
  <!-- * 项目主页：[fsr-vln](https://horizonrobotics.github.io/robot_lab/fsr-vln/) -->
  * 工作内容：负责系统架构设计与实现。利用前馈重建模型输出几何语义先验信息，实现鲁棒高精度、实时的纯视觉开放词汇语义建图。
...
* **人形机器人 VLN 导航系统**
  ...
  * 项目主页：[https://horizonrobotics.github.io/robot_lab/fsr-vln/](https://horizonrobotics.github.io/robot_lab/fsr-vln/) (100+ star)
...
* **VSLAM 视觉重建与导航**
  * 项目介绍：为 Real2Sim 视觉重建提供高精度相机位姿，并为足式机器人提供视觉导航定位方案。
  * 项目主页：[https://github.com/HorizonRobotics/GeoFlowSlam](https://github.com/HorizonRobotics/GeoFlowSlam) (100+ star)
...
* **AGV 物流机器人激光导航定位**
  * 项目介绍：POC 商业化项目，面向工厂货架场景的 AGV 自动搬运。
...
学术成果（工作期间）
======
* **FSR-VLN**: Fast and Slow Reasoning for Vision-Language Navigation with Hierarchical Multi-modal Scene Graph，[https://horizonrobotics.github.io/robot_lab/fsr-vln/](https://horizonrobotics.github.io/robot_lab/fsr-vln/)，IROS 2026 在投，共同一作
* **GeoFlow-SLAM**: A Robust Tightly-Coupled RGBD-Inertial and Legged Odometry Fusion SLAM for Dynamic Legged Robotics，[https://github.com/HorizonRobotics/GeoFlowSlam)](https://github.com/HorizonRobotics/GeoFlowSlam)，IROS 2025，第一作者
